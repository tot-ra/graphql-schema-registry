...
describe('app/database/sql-migration-source.js', () => {
	...
	it('should return available sql migrations as ordered list of objects', async () => {
		...
		assert.includeDeepOrderedMembers(migrations, [{file: '00_test_migr1.sql'}, {file: '01_test_migr2.sql'}], 'sql migrations should be sorted');
		assert.notIncludeDeepMembers(migrations, [{file: '02_test_migr3.js'}], 'js based migrations should not be returned');
	});
