...
exports.getLastUpdatedForActiveServices = async ({ trx = knex }) => {
	return exports.getSchemaLastUpdated({
		trx,
...
exports.getSchemaByServiceVersions = async ({ trx = knex, services }) => {
	...
	schema.push(
		...(await exports.getSchemaLastUpdated({
			trx,
...
exports.registerSchema = async ({ trx = knex, service }) => {
	...
	const result = await exports.getSchemaByServiceVersions({
		trx,
		services: [service]
	});
...
exports.getSchemasForServices = async ({
	serviceIds,
	limit = 100,
	offset = 0,
	filter = '',
