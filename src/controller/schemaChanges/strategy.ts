...
const changesType = {
	field: [ChangeType.FieldRemoved, ChangeType.EnumValueRemoved, ChangeType.FieldArgumentRemoved],
...
export class SchemaChangeStrategy {
	...
	private initializeStrategies() {
		...
		this.strategies.set('implementation', new ImplementationChangeStrategy());
	}
