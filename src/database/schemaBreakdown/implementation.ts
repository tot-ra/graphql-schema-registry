...
export class ImplementationTransactionRepository extends BreakDownRepository<
	Implementation,
	Implementation
> {
	...
	static getInstance(): ImplementationTransactionRepository {
		if (!ImplementationTransactionRepository.instance) {
			ImplementationTransactionRepository.instance =
				new ImplementationTransactionRepository();
		}
