...
import { DEACTIVATE_SCHEMA_ENTRY, ACTIVATE_SCHEMA_ENTRY } from '../../utils/mutations';
import { useParams } from 'react-router-dom';

const DeactivateSchemaButton = ({ schema }) => {
	const { serviceName } = useParams();
	const [deactivateSchema, { loading: deleting, error: deleteError }] = useMutation(
		DEACTIVATE_SCHEMA_ENTRY
	);

	const [activateSchema, { loading: activating, error: activateError }] = useMutation(
