...
- apollo composition library [migrated from MIT license to ELv2](https://www.apollographql.com/blog/announcement/moving-apollo-federation-2-to-the-elastic-license-v2/), which [adds limitations on how you can use it](https://github.com/apollographql/federation/blob/main/LICENSE#L22), which does not affect graphql-schema-registry source code as we only reference it (and its up to you, client, to install and use the library), but docker image *is affected* as it bundles/distributes the library. 
